...
const socialLinks = [
    {
      href: 'https://github.com/OmerSharivker',
    ...
    {
      href: 'https://www.linkedin.com/in/omersharivker/',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const Contact = () => {
    return (
       <section id="contact" className="section py-3">
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                     <div className="lg:mb-64 mb-12 lg:flex lg:flex-col">
                        ...
                        <div className="flex items-center gap-2 mt-auto">
                            {
                                socialLinks.map(({href,icon,},key)=>(
                                    <a key={key} href={href} target='_blank' className='w-12 h-12 grid place-items-center ring-inset ring-2
                                     ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950  active:bg-zinc-50/80' rel="noreferrer">{icon}</a>
                                ))
                            }
                        </div>
                     </div>

           <form action="https://getform.io/f/adrrnera" method='POST' className="xl:pl-10 2xl:pl-20
           ">
              ...
              <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                <div className="mb-4">
                    ...
                    required placeholder='Omer Sharivker' className='text-field reveal-up'/>
                </div>
                <div className="mb-4">
                    <label htmlFor="email" className="label reveal-up">
                      Email
                    </label>
                    <input type="email" name="email" id="email" autoComplete='name' 
                    required placeholder='omer@example.com' className='text-field reveal-up'/>
                </div>
              </div>
                      <div className="mb-4">
                      ...
                      <button type="submit" className='btn btn-primary reveal-up'>Submit</button>
           </form>
